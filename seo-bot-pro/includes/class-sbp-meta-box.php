...
class SBP_Meta_Box {
    ...
    public function render( WP_Post $post ) {
        ...
        <div class="sbp-meta-box">
            <p>
                <strong><?php esc_html_e( 'Meta Title:', 'seo-bot-pro' ); ?></strong><br>
                <span id="sbp-meta-title"><?php echo esc_html( $meta_title ?: '—' ); ?></span>
            </p>
            <p>
                <strong><?php esc_html_e( 'Meta Description:', 'seo-bot-pro' ); ?></strong><br>
                <span id="sbp-meta-desc"><?php echo esc_html( $meta_desc ?: '—' ); ?></span>
            </p>
            ...
            <input type="text" id="sbp-keyword" class="widefat" placeholder="<?php esc_attr_e( 'e.g. best running shoes', 'seo-bot-pro' ); ?>">
